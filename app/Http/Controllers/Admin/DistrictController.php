...
use App\Http\Requests\DistrictPostRequest as mainRequest;
use App\Helpers\Template as Template;
//use App\Models\District as mainModel;
//use App\Models\Province as provinceModel;
use App\Repositories\District\DistrictRepositoryInterface as RepositoryInterface;
use App\Repositories\Province\ProvinceRepositoryInterface;
use App\Services\AdminFilterService;

class DistrictController extends MainController implements InterfaceController {

    protected $controllerView = 'admin.pages.district.';
    protected $controllerName = 'district';
    protected $mainModel;
    protected $provinceModel;
    protected $filterService;

    public function __construct(RepositoryInterface $repository, ProvinceRepositoryInterface $repositoryProvine, AdminFilterService $filterService) {
