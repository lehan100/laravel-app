...
use App\Http\Requests\MediaPositionPostRequest as mainRequest;
use App\Helpers\Template as Template;
//use App\Models\MediaPosition as mainModel;
use App\Repositories\Media\PositionRepositoryInterface as RepositoryInterface;
class PositionController extends MainController implements InterfaceController
{
   protected $controllerView = 'admin.pages.media.position.';
   protected $controllerName = 'position';
   protected $mainModel;
