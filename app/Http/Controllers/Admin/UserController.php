...
use App\Http\Requests\UserPostRequest as mainRequest;
use App\Helpers\Template as Template;
//use App\Models\Users as mainModel;
use App\Repositories\User\UserRepositoryInterface as RepositoryInterface;

class UserController extends MainController implements InterfaceController
{
   protected $controllerView = 'admin.pages.user.';
