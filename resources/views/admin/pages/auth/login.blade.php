...
@section('content')
    @php
        ...
        $usernameForm = html()->text('username', '')->attributes( ['class' => $formInputAttr, 'required' => true]);
        $passwordForm = html()->password('password')->attributes( ['class' => $formInputAttr, 'required' => true]);
    @endphp
  {{html()->form('POST', route("$controllerName/post-login"))->attributes([
    'accept-charset' => 'UTF-8',
    'enctype' => 'multipart/form-data',
    'class' => 'form-signin',
    'id' => 'appForm',
])->open() }}
<h1 class="h3 mb-4 font-bold text-uppercase">Please sign in</h1>
    @include ('admin.templates.login_error')
    @include ('admin.templates.notify')
<div class="row mb-4 mt-3 align-items-center">
    <div class="col-1 text-right">
        <div class="input-text"><i class="fa fa-user"></i></div>
    </div>
    <div class="col">
        {{ $usernameForm }}
    </div>
...
<div class="row mb-4 align-items-center">
    <div class="col-1 text-right">
        <div class="input-text"><i class="fa fa-lock"></i></div>
    </div>
    <div class="col">
        {{ $passwordForm }}
    </div>
...
<div class="row mb-4 align-items-center">
    ...
    <div class="col">
        <button type="submit" class="btn btn-warning submit w-100">SIGN IN</button>
    </div>
</div>
...
$(function() {
  ...
  var config = {
    ...
    linkDist: Math.min(window.innerWidth, window.innerHeight) / 2.5,
