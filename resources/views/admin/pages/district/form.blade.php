...
@php
    ...
    $dataType = config("configs.location.district");
    $elements = [
        [
        ...
        [
            'label' => html()->label(for:'name', contents:'Tên')->attributes( ['class' => $formLabelAttr]),
        ...
        [
            'label' => html()->label(for:'name', contents:'Tỉnh/Thành Phố')->attributes( ['class' => $formLabelAttr]),
            'element' => html()->select('province_id', $provinceItems, @$item['province_id'])->attributes( ['class' => $errors->first('province_id') ? $formInputAttr . ' is-invalid' : $formInputAttr]),
            'error' => $errors->first('province_id') ? sprintf('<div class="invalid-feedback">%s</div>', $errors->first('province_id')) : '',
        ],
        [
