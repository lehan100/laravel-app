<table id="loadValueTable" class="table table-striped options-type-{{$type}}">
    ...
    <tbody id="loadValue">
      @if(isset($items) && count($items)>0)
        @include('admin.pages.optionentries.plugins.option_value',['type'=>$type,'items'=>$items])
      @else
          @include('admin.pages.optionentries.plugins.option_value',['type'=>$type])
      @endif
    </tbody>
</table>
