                    ...
                    <div class="row">
                        ...
                        <div class="title_right col-auto d-print-none">
                            @if (
                                ...
                                <button type="button"
                                    data-link="{{ route("$controllerName/post-shipping", ['type' => 'success']) }}"
                                    data-order-id="{{ $id }}" id="btn-shipping-success" class="btn btn-success"><i
                                        class="fa fa-check mr-2"></i>Đã giao hàng và thanh toán</button>
                            ...
                            <a href="javascript:;" class="btn btn-secondary" onclick="window.print();"><i
                                    class="fa fa-print"></i>
                                Print</a>
