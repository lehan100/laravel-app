...
@section("content")
<form method="POST" action="{{route("checkout/order")}}" accept-charset="UTF-8" enctype="multipart/form-data" id="formOrder">
    ...
    <div class="block-checkout container">
        ...
        <div class="row mb-4">
            <div class="col-12 col-md-8">
                @include('default.pages.checkout.payment.infomation')
                @include('default.pages.checkout.payment.payment')
                @include('default.pages.checkout.payment.shopping')
            </div>
            <div class="col-12 col-md-4">
                <div class="sticky-top">
                    @include("default.pages.checkout.payment.subtotal")
                </div>
            </div>
        </div>
    </div>
